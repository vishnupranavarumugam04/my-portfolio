export const DEFAULT_SITE_DATA = {
  ...
  skillsCategories: [
    ...
    },
    {
      ...
      skills: ["Computer Vision", "OpenCV", "YOLOv8", "Edge AI", "Object Detection", "Image Processing", "PyTorch / TensorFlow", "AI/ML Integration"]
    },
    {
      category: "Embedded Microcontrollers & IoT",
      skills: ["ESP32", "Arduino", "STM32", "Sensors & Actuators", "Motor Drivers", "I2C / UART / SPI", "BLE Mesh", "IoT Protocols"]
    },
    {
      category: "CAD Modeling & Mechanical Design",
      skills: ["SolidWorks", "Fusion 360", "3D Prototyping", "Kinematics Analysis", "Mechanical CAD", "Geometric Dimensioning", "DFM / Rapid Prototyping"]
    },
    {
      category: "Full-Stack & Intelligent Software",
      skills: ["C", "C++", "Python", "JavaScript", "TypeScript", "React", "Node.js / Express", "FastAPI", "REST APIs", "Tailwind CSS"]
    },
    {
